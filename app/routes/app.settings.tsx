    ...
    <s-page heading="Settings">
      ...
      <s-section heading="Shopify safety">
        <s-stack direction="block" gap="base">
          ...
          <s-text>
            Creating products here does not create Shopify products.
          </s-text>
          <s-text>CSV imports write only to PostgreSQL.</s-text>
          <s-text>
            Editing or deleting list items and products affects only this app
            database — never Shopify products, inventory, or orders.
          </s-text>
        </s-stack>
